                   ...
                   column(2,
                          wellPanel(
                            ...
                            actionButton(inputId = "sample.data",
                                         label =  "Load..."),
                            br(),
                            fileInput("jsonFiles", "Or upload json files",
                                      multiple = TRUE,
        ...
        tabPanel(title = "Spatial filtering",
                 fluidRow(
                   column(2,
                          ...
                          br(),
                          br(),
                          downloadButton('downloadData2', 'Save output'),
                                    br(),
                                    br(),
                 ...
                 fluidRow(
                   column(2,
                          ...
                          wellPanel(br(),
                                    ...
                                    br(),
                                    downloadButton('downloadData3', 'Save output'),
                                    br(),
                                    br(),
                 ...
                 fluidRow(
                   column(2,
                          wellPanel(
                            ...
                            downloadButton('downloadData4', 'Save output'),
                            br(),
                            br(),
                 ...
                 fluidRow(
                   column(2,
                          ...
                          wellPanel(
                            ...
                            br(),
                            br(),
                            downloadButton('downloadData5', 'Save output'),
                            br(),
                            br(),
        ...
        tabPanel(title = "Analysis output",
                 fluidRow(
                   column(2,
                          wellPanel(
                            ...
                            selectInput("in.select", "Exprimental condition",
                 ...
                 column(12,
                        wellPanel(
                          ...
                          selectInput("in.select0", "Exprimental condition",
                                      c("expr.cond1", "expr.cond2")))),
                 column(4, plotOutput("plot60.1")),
                 column(8, plotOutput("plot60.2")),
                 column(1, offset = 3, downloadButton('downloadData60.1', 'Save data 1.1')),
                 column(1, offset = 7, downloadButton('downloadData60.2', 'Save data 1.2')),
                 column(8, offset = 4, plotOutput("plot60.3")),
                 column(1, offset = 11, downloadButton('downloadData60.3', 'Save data 1.3')),
                 ...
                 column(12,
                        ...
                        wellPanel(
                          ...
                          checkboxGroupInput("inCheckboxGroup1",
                                             "Proteins", inline = TRUE),
                          selectInput("in.select1", "Exprimental condition",
                                      c("expr.cond1", "expr.cond2")))),
                 column(4, plotOutput("plot61.1")),
                 column(8,plotOutput("plot61.2")),
                 column(1, offset = 3, downloadButton('downloadData61.1', 'Save data 2.1')),
                 column(1, offset = 7, downloadButton('downloadData61.2', 'Save data 2.2')),
                 ...
                 column(12,
                        ...
                        wellPanel(
                          ...
                          checkboxGroupInput("inCheckboxGroup2",
                                             "Proteins", inline = TRUE),
                          selectInput("in.select2", "Exprimental condition",
                                      c("expr.cond1", "expr.cond2")))),
                 column(4, plotOutput("plot62.1")),
                 column(8, plotOutput("plot62.2")),
                 column(1, offset = 3, downloadButton('downloadData62.1', 'Save data 3.1')),
                 column(1, offset = 7, downloadButton('downloadData62.2', 'Save data 3.2')),
                 ...
                 column(12,
                        ...
                        wellPanel(
                          ...
                          checkboxGroupInput("inCheckboxGroup3",
                                             "Proteins", inline = TRUE),
                          selectInput("in.select3", "Exprimental condition",
                                      c("expr.cond1", "expr.cond2")))),
                 column(4, plotOutput("plot63.1")),
                 column(8, plotOutput("plot63.2")),
                 column(1, offset = 3, downloadButton('downloadData63.1', 'Save data 4.1')),
                 column(1, offset = 7, downloadButton('downloadData63.2', 'Save data 4.1')),
                 ...
                 column(12,
                        ...
                        wellPanel(
                          ...
                          checkboxGroupInput("inCheckboxGroup4",
                                             "Proteins", inline = TRUE),
                          selectInput("in.select4", "Exprimental condition",
                                      c("expr.cond1", "expr.cond2")))),
                 column(4, plotOutput("plot64.1")),
                 column(8, plotOutput("plot64.2")),
                 column(1, offset = 3, downloadButton('downloadData64.1', 'Save data 5.1')),
                 column(1, offset = 7, downloadButton('downloadData64.2', 'Save data 5.2')),
                 column(8, offset = 4, plotOutput("plot64.3")),
                 column(1, offset = 11, downloadButton('downloadData64.3', 'Save data 5.3')),
                 ...
                 column(12,
                        ...
                        wellPanel(
                          ...
                          checkboxGroupInput("inCheckboxGroup5",
                                             "Proteins", inline = TRUE),
                          selectInput("in.select5", "Exprimental condition",
                                      c("expr.cond1", "expr.cond2")))),
                 column(4, plotOutput("plot65.1")),
                 column(8, plotOutput("plot65.2")),
                 column(1, offset = 3, downloadButton('downloadData65.1', 'Save data 6.1')),
                 column(1, offset = 7, downloadButton('downloadData65.2', 'Save data 6.2')),
                 column(8, offset = 4,  plotOutput("plot65.3")),
                 column(1, offset = 11, downloadButton('downloadData65.3', 'Save data 6.3'),
                        br(),
                        br()
                 ),
